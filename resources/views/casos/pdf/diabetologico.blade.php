            ...
            <div class="col-md-12">
              ...
              <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <div class="row">
                          <div class="col-md-12">
                          <h5>{{ $diabetologico->medico }}</h5>
                          <label for="diabetologico[medico]"><i>{{ __('Médico de Cabecera') }}</i></label>
                          </div>
                      </div>

                      <div class="row">
                          <div class="col-md-6">
                            <h5>{{ $diabetologico->servicio }}</h5>
                            <label for="diabetologico[servicio]"><i>{{ __('Servicio') }}</i></label>
                          </div>

                          <div class="col-md-6">
                            <h5>{{ $diabetologico->contacto}}</h5>
                            <label for="diabetologico[contacto]"><i>{{ __('Contacto') }}</i></label>
                          </div>
                      </div>
                      <hr />
                      <div class="row">
                      ...
                      <div class="row">
                          <div class="col-md-2 radio-inline">
                              ...
                              <label for="diabetologico[dm]">{{ __('1') }}</label>
                          </div>
